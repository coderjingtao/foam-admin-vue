<template>
  <el-row type="flex" class="row-bg" justify="center">
    <el-col :xl="6" :lg="7">
      <h2>Welcome to NewAim Admin System</h2>
      <el-image :src="require('@/assets/newaim.png')" style="height: 180px; width: 230px;"></el-image>
      <p>Please contact [Joseph Liu] to get Login Credentials</p>
    </el-col>
    ...
    return {
      ...
      rules: {
        ...
        code: [
          ...
          { min: 5, max: 5, message: 'please input 5 digital', trigger: 'blur' }
        ],
      },
      captchaImg: null
    };
